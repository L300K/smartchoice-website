...
export default function Home() {
    ...
    useEffect(() => {
        router.prefetch('/loykrathong/sit-2/01');
        router.prefetch('/loykrathong/10');
    }, [router]);
    ...
    return (
        <div className="h-full w-full bg-white relative overflow-hidden">
            <div className="fixed inset-0 z-0">
                <Image
                    src="/smartchoice-website/loykrathong/15.png"
                    alt="Background"
                    fill
            ...
            <div className="fixed bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col space-y-4">
                <BlurFade delay={0.3} className="flex flex-col space-y-4" inView>
                    <Button
                        variant="outline"
                        className="text-[22px]"
                        onClick={() => router.push('/loykrathong/sit-2/01')}
                    >
                        ใส่ถุงยาง
                    </Button>
                    <Button
                        variant="outline"
                        className="text-[22px]"
                        onClick={() => router.push('/loykrathong/10')}
                    >
                        ไม่ใส่ถุงยาง
                    </Button>
                </BlurFade>
