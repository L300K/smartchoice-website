    ...
    return (
        <div className="h-full w-full bg-white relative overflow-hidden">
            <div className="fixed inset-0 z-0">
                <Image
                    src="/smartchoice-website/loykrathong/19.png"
                    alt="Background"
                    fill
            ...
            <div className="fixed bottom-60 left-1/2 transform -translate-x-1/2 flex flex-col space-y-4">
                <BlurFade delay={0.3} className="flex flex-col space-y-4" inView>
                    <Button
                        variant="outline"
                        className="text-[22px]"
                        onClick={() => router.push('/loykrathong/sit-4')}
                    >
                        นับวันปลอดภัย
                    </Button>
                    <Button
                        variant="outline"
                        className="text-[22px]"
                        onClick={() => router.push('/loykrathong/sit-5')}
                    >
                        หลั่งนอก
                    </Button>
                    <Button
                    ...
                    <Button
                        variant="outline"
                        className="text-[22px]"
                        onClick={() => router.push('/loykrathong/05')}
                    >
                        ยาคุมกำเนิดฉุกเฉิน
                    </Button>
                </BlurFade>
