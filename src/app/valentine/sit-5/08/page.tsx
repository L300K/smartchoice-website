...
export default function Home() {
    ...
    useEffect(() => {
        router.prefetch('/valentine/sit-5/09');
        router.prefetch('/valentine/sit-5/10');
    }, [router]);
    ...
    return (
        <div className="h-full w-full bg-white relative overflow-hidden">
            <div className="fixed inset-0 z-0">
                <Image
                    src="/smartchoice-website/valentine/27.png"
                    alt="Background"
                    fill
            ...
            <div className="fixed bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col space-y-4">
                <BlurFade delay={0.3} className="flex flex-col space-y-4" inView>
                    <Button
                        ...
                        onClick={() => router.push('/valentine/sit-5/09')}
                    >
                        ปรึกษาเพื่อน
                    </Button>
                    <Button
                        variant="outline"
                        className="text-[24px] px-8 py-6"
                        onClick={() => router.push('/valentine/sit-5/10')}
                    >
                        ไม่ปรึกษา
                    </Button>
                </BlurFade>
